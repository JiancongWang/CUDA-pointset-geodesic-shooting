...
int main(int argc, char *argv[]){
	...
	Check::check(param.fnTemplate.length(), "Missing template filename");
	Check::check(param.fnTarget.length(), "Missing target filename");
	Check::check(param.fnOutput.length(), "Missing output filename");

	// Run the actual program
	PointSetShootingProblem_CUDA::shooting(param);
